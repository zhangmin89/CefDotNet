...
namespace CefGlue.Tests.Javascript
{
    public class NativeObjectInteropTests : TestBase
    {
        ...
        private static readonly DateTime DateValue = new DateTime(1995, 12, 17, 3, 24, 0, DateTimeKind.Utc);
        ...
        protected class NativeObject
        {
            ...
            {
                return new Person() {Name = "John", Age = 30, BirthDate = DateValue};
            }
        }
        ...
        public async Task MethodParamsArePassed()
        {
            ...
            Assert.AreEqual(DateValue, result[2]);
        ...
        public async Task MethodWithObjectParamIsPassed()
        {
            ...
            Assert.AreEqual(DateValue, arg.BirthDate);
        }
